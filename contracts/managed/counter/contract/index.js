...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      incrementCounter: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`incrementCounter: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const privateSecret_0 = args_1[1];
        ...
        if (!(typeof(privateSecret_0) === 'bigint' && privateSecret_0 >= 0n && privateSecret_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('incrementCounter',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(privateSecret_0),
        ...
        const result_0 = this._incrementCounter_0(context,
                                                  partialProofData,
                                                  privateSecret_0);
  ...
  _incrementCounter_0(context, partialProofData, privateSecret_0) {
    __compactRuntime.assert(privateSecret_0 > 0n,
                            'Increment amount must be greater than zero');
    const inc_0 = privateSecret_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 21 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
